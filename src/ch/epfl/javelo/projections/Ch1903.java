...
public final class Ch1903 {
    ...
    public static double e(double lon, double lat){
        ...
        double E = 26000072.37 + (211455.93*lambda1) - (10938.51*lambda1*phi1) - (0.36*lambda1*Math.pow(phi1,2)) - (44.54* Math.pow(lambda1, 3)) ;
        return E;
    }
    ...
    public static double lon (double e, double n){
        ...
        double lon = toRadians(lambda0) * (100/36);
        return lon;
    }
    ...
    public static double lat (double e, double n){
        ...
        double lat = toRadians(phi0) * (100/36);
        return lat;
    }
}
