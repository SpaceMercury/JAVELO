...
class GraphEdgesTest {
    ...
    @Test
    void GraphEdgesCase2() {
        ByteBuffer edgesBuffer = ByteBuffer.allocate(10);
        // Sens : normal. Nœud destination : 12.
        edgesBuffer.putInt(0, 12);
        // Longueur : 0x10.b m (= 16.6875 m)
        edgesBuffer.putShort(4, (short) 0x10_b);
        // Dénivelé : 0x10.0 m (= 16.0 m)
        ...
        assertEquals(2022, edges.attributesIndex(0));
        float[] expectedSamples = new float[]{
                384.75f, 384.625f, 384.5625f, 384.5f, 384.375f,
                384.375f, 384.375f, 384.375f, 384.375f, 384.375f
        };
        assertArrayEquals(expectedSamples, edges.profileSamples(0));
    ...
    void GraphEdgesCase1() {
        ...
        ShortBuffer elevations = ShortBuffer.wrap(new short[]{
                (short) 0x180C, (short) 0x000F,
                (short) 0x000F, (short) 0x000F,
                (short) 0x000F, (short) 0x0000,
                (short) 0x0000, (short) 0x0000,
                (short) 0x0000, (short) 0x0000,
        });
        ...
        assertEquals(2022, edges.attributesIndex(0));
        float[] expectedSamples = new float[]{
                384.75f, 385.6875f, 386.625f, 387.5625f, 388.5f,
                388.5f, 388.5f, 388.5f, 388.5f, 388.5f
        };
        assertArrayEquals(expectedSamples, edges.profileSamples(0));
    ...
    void GraphEdgesCase0() {
        ...
        IntBuffer profileIds = IntBuffer.wrap(new int[]{
                // Type : 0. Index du premier échantillon : 0.
                (0 << 30) | 0
        });
